## Wild Magic Surges: Magical Mishaps
...
31. The caster's clothes become uncomfortably tight.
32. If the spell would kill the target, the target's extremities fly apart at the joints. The caster becomes trapped inside a giant glass ball.
...
43. Any applicable saving throw the spell's target would
44. make automatically fails. The spell slot spent on this spell is retained.
45. The spell appears to fail, but occurs 1 round later.
46. The caster and all creatures within a 20' radius heal 3d8 hit points. The caster suffers hiccups for the next hour.
47. All attack rolls, saving throws, and ability checks are made at disadvantage, and the noise is loud enough to possibly attract attention.
...
72. The spell fires in random direction if its range is not
73. touch. The caster's teeth fall out.
74. The target becomes petrified for 1d4 rounds.
75. Any ferrous material the target possesses immediately corrodes.
76. The air within a 5' radius of the caster turns into a random element (fire, earth, water)
...
85. The target's bones are turned into gold. Their speed until remove curse is applied. 
